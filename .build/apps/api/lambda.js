...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var expressServer, nestApp;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    expressServer = express();
                    return [4 /*yield*/, core_1.NestFactory.create(app_module_1.AppModule, new platform_express_1.ExpressAdapter(expressServer))];
                case 1:
                    nestApp = _a.sent();
                    return [4 /*yield*/, nestApp.init()];
                case 2:
                    _a.sent();
                    return [2 /*return*/, serverlessExpress.createServer(expressServer)];
            }
        });
    });
}
